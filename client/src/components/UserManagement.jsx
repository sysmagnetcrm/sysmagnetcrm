        ...
        {showAddUser && (
          <div className="fixed inset-0 bg-[#101828]/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white dark:bg-[#171A21] border border-[#E4E7EC] dark:border-[#2B313C] rounded-2xl shadow-xl w-full max-w-md overflow-hidden"
            >
              <div className="p-6 border-b border-[#E4E7EC] dark:border-[#2B313C] flex justify-between items-center bg-[#F8F9FB] dark:bg-[#1E232C]">
                <h2 className="text-[18px] font-bold text-[#101828] dark:text-white">Add New User</h2>
                <button onClick={() => setShowAddUser(false)} className="text-[#667085] dark:text-gray-400 hover:bg-[#F8F9FB] dark:hover:bg-[#202631] p-2 rounded-lg">
              ...
              <form onSubmit={(e) => {
                ...
                <div className="p-6 space-y-4">
                  <div>
                    <label className="block text-[13px] font-semibold text-[#344054] dark:text-gray-300 mb-1.5">Full Name *</label>
                    <input name="name" required className="w-full bg-white dark:bg-[#1E232C] border border-[#E4E7EC] dark:border-[#343B48] rounded-xl px-3 py-2 text-[14px] text-[#101828] dark:text-white focus:outline-none focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="John Doe" />
                  </div>
                  <div>
                    <label className="block text-[13px] font-semibold text-[#344054] dark:text-gray-300 mb-1.5">Email Address *</label>
                    <input name="email" type="email" required className="w-full bg-white dark:bg-[#1E232C] border border-[#E4E7EC] dark:border-[#343B48] rounded-xl px-3 py-2 text-[14px] text-[#101828] dark:text-white focus:outline-none focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="john@example.com" />
                    <p className="text-[12px] text-[#667085] dark:text-gray-400 mt-1">We'll use this address for authentication.</p>
                  </div>
                  <div>
                    <label className="block text-[13px] font-semibold text-[#344054] dark:text-gray-300 mb-1.5">Temporary Password *</label>
                    <input name="password" type="password" required className="w-full bg-white dark:bg-[#1E232C] border border-[#E4E7EC] dark:border-[#343B48] rounded-xl px-3 py-2 text-[14px] text-[#101828] dark:text-white focus:outline-none focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="••••••••" />
                  </div>
                  <div>
                ...
                <div className="p-6 border-t border-[#E4E7EC] dark:border-[#2B313C] bg-[#F8F9FB] dark:bg-[#1E232C] flex justify-end gap-3">
                  <button type="button" onClick={() => setShowAddUser(false)} className="px-4 py-2 bg-white dark:bg-[#171A21] border border-[#E4E7EC] dark:border-[#2B313C] text-[#344054] dark:text-gray-300 font-semibold text-[14px] rounded-xl hover:bg-gray-50 dark:hover:bg-[#202631] transition-colors">
                    Cancel
                  </button>
        ...
        {editingUser && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-[400px] bg-white dark:bg-[#171A21] shadow-2xl z-50 flex flex-col border-l border-[#E4E7EC] dark:border-[#2B313C]"
            >
              <div className="p-6 border-b border-[#E4E7EC] dark:border-[#2B313C] flex justify-between items-center bg-[#F8F9FB] dark:bg-[#1E232C]">
                <h2 className="text-[18px] font-bold text-[#101828] dark:text-white">Edit User</h2>
                <button onClick={() => setEditingUser(null)} className="text-[#667085] dark:text-gray-400 hover:bg-[#E4E7EC] dark:hover:bg-[#202631] p-2 rounded-lg transition-colors">
                  <Icon icon="mdi:close" className="w-5 h-5" />
                </button>
              </div>
              <div className="p-6 flex-1 overflow-y-auto">
                <form id="edit-user-form" onSubmit={(e) => {
                  ...
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                      <div className="text-[16px] font-bold text-[#101828] dark:text-white">{editingUser.email}</div>
                      <div className="text-[13px] text-[#667085] dark:text-gray-400">Email cannot be changed here.</div>
                    </div>
                  </div>
                  <div>
                    <label className="block text-[13px] font-semibold text-[#344054] dark:text-gray-300 mb-1.5">Full Name</label>
                    <input name="name" defaultValue={editingUser.name} required className="w-full bg-white dark:bg-[#1E232C] border border-[#E4E7EC] dark:border-[#343B48] rounded-xl px-3 py-2 text-[14px] text-[#101828] dark:text-white focus:outline-none focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" />
                  </div>
                  <div>
                    <label className="block text-[13px] font-semibold text-[#344054] dark:text-gray-300 mb-1.5">Role</label>
              ...
              <div className="p-6 border-t border-[#E4E7EC] dark:border-[#2B313C] bg-[#F8F9FB] dark:bg-[#1E232C] flex gap-3">
                <button type="button" onClick={() => setEditingUser(null)} className="flex-1 py-2.5 bg-white dark:bg-[#171A21] border border-[#E4E7EC] dark:border-[#2B313C] text-[#344054] dark:text-gray-300 font-semibold text-[14px] rounded-xl hover:bg-gray-50 dark:hover:bg-[#202631] transition-colors">
                  Cancel
                </button>
          ...
          <div className="fixed inset-0 bg-[#101828]/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="p-6 text-center">
                ...
                <h3 className="text-[18px] font-bold text-[#101828] dark:text-white mb-2">Delete User?</h3>
                <p className="text-[14px] text-[#667085] dark:text-gray-300">
                  You're about to remove <strong className="text-[#344054] dark:text-white">{deletingUser.name || deletingUser.email}</strong>. This action cannot be easily undone.
                </p>
              </div>
              <div className="p-4 border-t border-[#E4E7EC] dark:border-[#2B313C] bg-[#F8F9FB] dark:bg-[#1E232C] flex gap-3">
                <button onClick={() => setDeletingUser(null)} className="flex-1 py-2 bg-white dark:bg-[#171A21] border border-[#E4E7EC] dark:border-[#2B313C] text-[#344054] dark:text-gray-300 font-semibold text-[14px] rounded-xl hover:bg-gray-50 dark:hover:bg-[#202631] transition-colors">
                  Cancel
                </button>
        ...
        {showPermissions && (
          <>
            ...
            <motion.div
              ...
              exit={{ x: '100%' }}
              transition={{ type: 'spring', damping: 25, stiffness: 200 }}
              className="fixed inset-y-0 right-0 w-[540px] max-w-[100vw] bg-white dark:bg-[#171A21] shadow-2xl z-50 flex flex-col border-l border-[#E4E7EC] dark:border-[#2B313C]"
            >
              <div className="p-6 border-b border-[#E4E7EC] dark:border-[#2B313C] flex justify-between items-center bg-[#F8F9FB] dark:bg-[#1E232C]">
                <div>
                  <h2 className="text-[18px] font-bold text-[#101828] dark:text-white">Manage Role Permissions</h2>
                  <p className="text-[13px] text-[#667085] dark:text-gray-400 mt-0.5">Configure feature capabilities per role in database</p>
                </div>
                <button onClick={() => setShowPermissions(false)} className="text-[#667085] dark:text-gray-400 hover:bg-[#E4E7EC] dark:hover:bg-[#202631] p-2 rounded-lg transition-colors">
                  <Icon icon="mdi:close" className="w-5 h-5" />
                </button>
              </div>
              <div className="p-6 flex-1 overflow-y-auto bg-white dark:bg-[#171A21] space-y-6">
                <div>
                  <label className="block text-[13px] font-semibold text-[#344054] dark:text-gray-300 mb-1.5">Select Role to Edit</label>
                  <select
                    value={selectedRoleForPerms}
                    onChange={(e) => setSelectedRoleForPerms(e.target.value)}
                    className="w-full bg-white dark:bg-[#1E232C] border border-[#E4E7EC] dark:border-[#343B48] rounded-xl px-4 py-2 text-sm font-semibold text-[#101828] dark:text-white focus:outline-none focus:border-brand-orange"
                  >
                    {roles.map(r => (
                ...
                <div className="space-y-6">
                  {Object.entries(permissionsByCategory).map(([category, perms]) => (
                    <div key={category} className="border border-[#E4E7EC] dark:border-[#2B313C] rounded-xl p-4 bg-[#F8F9FB]/50 dark:bg-[#1E232C]/50">
                      <div className="font-bold text-[14px] text-[#101828] dark:text-white mb-3 flex items-center justify-between">
                        <span>{category}</span>
                        <span className="text-xs text-[#667085] dark:text-gray-400 font-normal">{perms.length} capabilities</span>
                      </div>
                      <div className="space-y-2">
                        {perms.map(p => {
                          const isChecked = selectedPermIds.has(p.id);
                          return (
                            <label key={p.id} className="flex items-start gap-3 p-2 rounded-lg hover:bg-white dark:hover:bg-[#202631] transition-colors cursor-pointer">
                              <input
                                type="checkbox"
                                checked={isChecked}
                              ...
                              />
                              <div>
                                <div className="text-xs font-semibold text-[#101828] dark:text-white">{p.name}</div>
                                <div className="text-[11px] text-[#667085] dark:text-gray-400">{p.description}</div>
                              </div>
                            </label>
                          );
                        })}
              ...
              <div className="p-6 border-t border-[#E4E7EC] dark:border-[#2B313C] bg-[#F8F9FB] dark:bg-[#1E232C] flex justify-between items-center">
                <button onClick={() => setShowPermissions(false)} className="px-4 py-2.5 bg-white dark:bg-[#171A21] border border-[#E4E7EC] dark:border-[#2B313C] text-[#344054] dark:text-gray-300 font-semibold text-[14px] rounded-xl hover:bg-gray-50 dark:hover:bg-[#202631] transition-colors">
                  Cancel
                </button>
                <button
